...
class HomeChooseImage extends StatefulWidget {
  const HomeChooseImage({Key? key}) : super(key: key);

  @override
  State<HomeChooseImage> createState() => _HomeChooseImageState();
}

class _HomeChooseImageState extends State<HomeChooseImage> {
                        ...
                        if (stateGame.selectedWordsWidget.length == 3) {
                          ...
                          if (_wordsSelectedShuffled[stateGame.selectedIndex4]
                            ...
                            context.read<GamesHandlerCubit>().wordManupilation(
                                ...
                                indexType: 4);
                            // setState(() {
                            //   _wordTrue.add(_wordsSelected[index]);
                            //   _selectedIndex += 1;
                            // });
                            context.read<GamesHandlerCubit>().updateScore(
                                wordsList: WordsList(
